...
#ifndef __ZLEWLIMAGEMANAGER_H__
#define __ZLEWLIMAGEMANAGER_H__
...
class ZLEwlImageData : public ZLImageData {

	public:
		ZLEwlImageData() : myImageData(0), myX(0), myY(0) {}
		~ZLEwlImageData() { 
	...
	private:
		...
		friend class ZLEwlImageManager;
};

class ZLEwlImageManager : public ZLImageManager {

	public:
		static void createInstance() { ourInstance = new ZLEwlImageManager(); }
