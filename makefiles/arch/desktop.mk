...
ifeq "$(UI_TYPE)" "ewl"
  UILIBS = $(shell pkg-config --libs xcb xcb-image evas ewl pango pangoft2 glib libpng freetype2) -ljpeg -lungif -lrt 
  EWLINCLUDE = $(shell pkg-config --cflags xcb xcb-image evas ewl pango pangoft2 glib libpng freetype2)
  ZLSHARED = no
endif
